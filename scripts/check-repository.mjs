...
const mustExist = [
  ...
  "tests/release-engineering.test.ts",
...
// Environment files may exist locally (they are generated by the hosting
// platform) but must never be committed. Fail only when they are tracked.
