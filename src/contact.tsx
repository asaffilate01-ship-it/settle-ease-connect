...
function Contact() {
  ...
  const submit = useMutation({
    ...
    onSuccess: () => setForm({ fullName: "", email: "", subject: "", message: "", website: "" }),
  });
      ...
      <section className="mx-auto grid max-w-7xl gap-12 px-4 py-12 sm:py-20 sm:px-6 lg:grid-cols-2 lg:px-8">
        ...
        >
          {submit.isSuccess && (
            <div
              role="status"
              className="mb-5 flex items-start gap-2 rounded-xl border border-emerald-500/30 bg-emerald-500/10 p-3 text-sm text-emerald-800 dark:text-emerald-200"
            >
          ...
          <div className="grid gap-4">
            ...
            <p className="text-xs text-muted-foreground">
              We use your details only to respond to this enquiry. See our privacy notice for more
              information.
            </p>
          </div>
        </form>
