...
export const LIFE_EVENT_PLAYBOOKS: Playbook[] = [
  ...
  },
  {
    ...
    title: "Relocation abroad",
    summary: "Abmeldung, pension export, insurance cancellations, tax farewell.",
    authoritiesToNotify: ["Bürgeramt (Abmeldung)", "Finanzamt (Wegzugsteuer)", "Krankenkasse", "Deutsche Rentenversicherung", "Employer"],
    insurancesToClaim: ["health_cover_transition", "pension_export", "unemployment_export_u2"],
    documentsRequired: ["Abmeldebestätigung", "Lease termination", "New address abroad", "Pension policy IDs"],
    steps: [
      { actor: "client", title: "Abmeldung at Bürgeramt", description: "Within 14 days before/after leaving.", deadlineDays: 14 },
      { actor: "tax_admin", title: "Assess Wegzugsteuer", description: "For shareholders and high earners.", deadlineDays: 30 },
      { actor: "benefits_admin", title: "Apply for PD U2 (unemployment export)", description: "If moving to another EU country while claiming ALG.", deadlineDays: 30 },
    ],
  },
];
