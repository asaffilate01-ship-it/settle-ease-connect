...
const FAMILY_DESTINATIONS = [
  ...
  ["Family access", "/app/family-access"],
  ["Privacy requests", "/app/privacy-requests"],
...
const STAFF_DESTINATIONS = [
  ...
  ["CRM", "/portal/crm"],
  ["Enquiry inbox", "/portal/enquiries"],
  ...
  ["Data protection", "/portal/privacy"],
  ["Auditor console", "/portal/auditor"],
  ["Partner delivery", "/portal/partner-push"],
] as const;
