...
function Page() {
  return (
    <LegalArticle title="Allgemeine Geschäftsbedingungen" updated="2026-08-01">
      <BilingualNote />

      <LegalSection title="1. Anbieter">
        <p>
          Anbieter im Sinne des § 5 DDG ist {legalOperatorLabel()}
      ...
      <LegalSection title="6. Widerrufsbelehrung für Verbraucher (§§ 355, 312g BGB)">
        <p>
          ...
          uns ({legalOperatorLabel()}, {company.streetAddress || "Anschrift laut Impressum"}, {company.postalCity}, E-Mail
          {" "}<a href="mailto:widerruf@beistandplus.de">widerruf@beistandplus.de</a>) mittels einer
