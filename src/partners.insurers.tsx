    ...
    <div className="min-h-screen">
      ...
      <section className="mx-auto max-w-4xl px-4 py-12 sm:py-20 sm:px-6 lg:px-8">
        ...
        <div className="mt-4 rounded-xl border border-amber-500/40 bg-amber-500/10 p-4 text-sm">
          <strong>Pre-contract planning document.</strong> Volumes, commercials, regulatory route
          and integrations below are proposals and must not be presented as active arrangements.
        </div>
        ...
        <div className="mt-16">
          ...
          <ul className="mt-6 space-y-3 text-muted-foreground">
            ...
            <li>• <strong className="text-foreground">Regulated route required.</strong> Launch depends on a contracted and verified §34d GewO intermediary, professional indemnity cover and approved customer disclosures.</li>
          </ul>
        </div>
        ...
        <div className="mt-16 rounded-xl border bg-accent/30 p-8">
          ...
          <div className="mt-4 text-sm">
            <div><strong>Contact:</strong> partnerships@beistandplus.de</div>
