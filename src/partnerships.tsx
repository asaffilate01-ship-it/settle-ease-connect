...
const tracks: Track[] = [
  {
    ...
    contactEmail: "universities@beistandplus.de",
  },
  {
    id: "ngos",
    ...
    contactEmail: "ngo@beistandplus.de",
  },
  {
    id: "banks",
    name: "Banks & Fintechs",
    ...
    contactEmail: "banking@beistandplus.de",
  },
  {
    id: "jobcenter",
    ...
    contactEmail: "jobcenter@beistandplus.de",
  },
  {
    id: "housing",
    ...
    contactEmail: "housing@beistandplus.de",
  },
  {
    id: "employers",
    ...
    contactEmail: "employers@beistandplus.de",
  },
  {
    id: "language-schools",
    ...
    contactEmail: "schools@beistandplus.de",
  },
  {
    ...
    contactEmail: "recruiters@beistandplus.de",
  },
  {
    ...
    contactEmail: "relocation@beistandplus.de",
  },
  {
    ...
    contactEmail: "training@beistandplus.de",
  },
];
      ...
      <section className="border-t border-border/60 bg-parchment/40">
        <div className="mx-auto max-w-4xl px-4 py-16 text-center sm:px-6 lg:px-8">
          ...
          <div className="mt-6 flex flex-wrap justify-center gap-3">
            <Button asChild>
              <a href="mailto:partnerships@beistandplus.de">Email partnerships@beistandplus.de</a>
            </Button>
