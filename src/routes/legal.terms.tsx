  ...
  head: () => ({
    meta: [
      { title: "AGB — BeistandPlus" },
      {
        name: "description",
        content:
          "Allgemeine Geschäftsbedingungen und Widerrufsbelehrung nach deutschem Recht (BGB, DDG).",
      },
  ...
  return (
    <LegalArticle title="Allgemeine Geschäftsbedingungen" updated="2026-04-01">
      ...
      <LegalSection title="1. Anbieter">
        <p>
          Anbieter im Sinne des § 5 DDG ist {legalAddressInline()}
      ...
      <LegalSection title="2. Geltungsbereich, Vertragssprache">
        <p>
          ...
          Zweifel die deutsche Fassung. Abweichende Bedingungen erkennen wir nicht an, soweit ihnen
          nicht ausdrücklich zugestimmt wurde.
        </p>
      </LegalSection>
      ...
      <LegalSection title="3. Leistungen">
        <p>
          ...
          Steuerberater, Ärzte, Bestatter, Übersetzer). BeistandPlus ist selbst{" "}
          <strong>keine</strong>
      ...
      <LegalSection title="4. Vertragsschluss">
        <p>
          ...
          Nutzungsvertrags ab. Der Vertrag kommt mit unserer Bestätigung per E-Mail zustande. Sie
          sind mindestens 18 Jahre alt und handeln entweder als Verbraucher (§ 13 BGB) oder als
          Unternehmer (§ 14 BGB).
        </p>
      </LegalSection>
      ...
      <LegalSection title="5. Preise, Zahlung, Verbraucher-Abo-Rechte (§ 312k BGB)">
        <p>
          ...
          Zahlungsdienstleister. Bei Verträgen mit Verbrauchern über Dauerschuldverhältnisse gilt §
          312k BGB: Kündigung jederzeit über die im Konto bereitgestellte Kündigungs-Schaltfläche
      ...
      <LegalSection title="6. Widerrufsbelehrung für Verbraucher (§§ 355, 312g BGB)">
        <p>
          ...
          <a href={`mailto:${publicLegal.legalEmail}`}>{publicLegal.legalEmail}</a>) mittels einer
          eindeutigen Erklärung (z. B. per Brief oder E-Mail) über Ihren Entschluss, diesen Vertrag
          zu widerrufen, informieren. Zur Wahrung der Widerrufsfrist reicht es aus, dass Sie die
          Mitteilung vor Ablauf der Widerrufsfrist absenden.
        </p>
        <p>
          <strong>Folgen des Widerrufs.</strong> Wenn Sie diesen Vertrag widerrufen, erstatten wir
          Ihnen alle Zahlungen unverzüglich und spätestens binnen vierzehn Tagen zurück. Haben Sie
          verlangt, dass die Dienstleistung während der Widerrufsfrist beginnen soll, so haben Sie
          uns einen angemessenen Betrag für die bis zum Widerruf bereits erbrachte Leistung zu
          zahlen.
        </p>
        <p>
          <strong>Vorzeitiges Erlöschen.</strong> Das Widerrufsrecht erlischt bei einem Vertrag zur
          Erbringung von Dienstleistungen, wenn wir die Dienstleistung vollständig erbracht haben
          und mit der Ausführung erst begonnen haben, nachdem Sie dazu Ihre ausdrückliche Zustimmung
          gegeben und gleichzeitig Ihre Kenntnis davon bestätigt haben, dass Sie Ihr Widerrufsrecht
          bei vollständiger Vertragserfüllung verlieren (§ 356 Abs. 4 BGB).
        </p>
      </LegalSection>
      ...
      <LegalSection title="7. Pflichten der Nutzenden">
        <p>
          ...
          hochzuladen, Behörden nicht zu täuschen und Rechte Dritter zu wahren. Verstöße berechtigen
          uns zur Sperrung.
        </p>
      </LegalSection>
      ...
      <LegalSection title="8. Haftung">
        <p>
          ...
          (Kardinalpflichten) ist unsere Haftung auf den vertragstypischen, vorhersehbaren Schaden
      ...
      <LegalSection title="10. Streitbeilegung, Rechtswahl, Gerichtsstand">
        <p>
          ...
          <a href="/legal/complaints">Beschwerdeverfahren</a>. Wir sind gemäß § 36 VSBG nicht
          verpflichtet und nicht bereit, an Verbraucherschlichtungsverfahren teilzunehmen.
        </p>
      </LegalSection>

      <LegalSection title="11. Änderungen dieser AGB">
        <p>
          Wesentliche Änderungen kündigen wir mindestens 30 Tage vorab per E-Mail und In-App-Hinweis
          an. Widersprechen Sie nicht binnen dieser Frist, gelten die Änderungen als angenommen; wir
          weisen Sie hierauf gesondert hin.
        </p>
      </LegalSection>
    </LegalArticle>
  );
