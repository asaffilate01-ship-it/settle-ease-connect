  ...
  head: () => ({
    meta: [
      { title: "Trust, compliance & SLAs — BeistandPlus" },
      {
        name: "description",
        content:
          "Implemented BeistandPlus security controls, pre-launch evidence requirements, partner checks and service targets.",
      },
      { property: "og:title", content: "Trust, compliance & SLAs — BeistandPlus" },
      {
        property: "og:description",
        content:
          "Implemented controls and the external evidence BeistandPlus must complete before launch.",
      },
    ...
    <div className="min-h-screen">
        ...
        <div className="relative mx-auto max-w-7xl px-4 py-12 sm:py-20 sm:px-6 lg:px-8">
          <div className="max-w-3xl">
            ...
            <p className="mt-4 max-w-2xl text-lg text-white/70">
              This page separates controls implemented in the product from licences, contracts and
              operational evidence that must be completed before public launch.
            </p>
            <div className="mt-6 flex flex-wrap gap-2 text-xs">
              <Chip>Row-level access controls</Chip>
              <Chip>Server-enforced MFA</Chip>
              <Chip>Private document storage</Chip>
              <Chip>Audited sensitive actions</Chip>
            </div>
          </div>
        </div>
      </section>
      ...
      <section className="mx-auto max-w-7xl px-4 py-16 sm:px-6 lg:px-8">
        ...
        <div className="mt-8 grid gap-4 md:grid-cols-2 lg:grid-cols-3">
          <BadgeCard
            ...
            body="Insurance distribution remains disabled until a contracted §34d GewO intermediary, registration number and responsibility split are recorded on each live quote."
            status="Pre-launch evidence"
          />
          <BadgeCard
            icon={Landmark}
            title="BaFin-regulated underwriters"
            body="A production insurance journey must identify the underwriting carrier and confirm its regulatory status before a customer can apply or consent to referral."
            status="Required"
          />
          <BadgeCard
            icon={Lock}
            title="DSGVO / GDPR aligned"
            body="Privacy contact, processing records, legal bases, processor agreements and international-transfer safeguards must match the final production configuration."
            status="In progress"
          />
          <BadgeCard
            icon={Server}
            title="German data residency"
            body="The production hosting region, backup location and subprocessors must be verified from supplier contracts and published before launch."
          ...
          <BadgeCard
            ...
            body="Tax advice or filing must be handed to a contracted Steuerberater or other authorised provider whose registration is verified for the engagement."
            status="Required"
          />
        </div>
      </section>
      ...
      <section className="bg-parchment/50">
        <div className="mx-auto max-w-7xl px-4 py-16 sm:px-6 lg:px-8">
          ...
          <h2 className="display-lg text-balance mt-3 max-w-3xl font-semibold">
            The minimum checks required before an expert can be activated.
          </h2>
          <p className="mt-3 max-w-3xl text-sm text-muted-foreground">
            These are launch acceptance criteria. The operations team must retain evidence and
            complete periodic rechecks; the platform must not display a verified badge without it.
          </p>
      ...
      <section className="mx-auto max-w-7xl px-4 py-16 sm:px-6 lg:px-8">
        ...
        <h2 className="display-lg text-balance mt-3 max-w-3xl font-semibold">
          Service targets to adopt only when staffing is proven.
        </h2>
        <p className="mt-3 max-w-3xl text-sm text-muted-foreground">
          The targets below are proposed service levels. They must not be sold as contractual SLAs
          until monitoring, on-call cover, escalation and credit handling have been tested.
        </p>
      ...
      <section className="mx-auto max-w-7xl px-4 pb-16 sm:px-6 lg:px-8">
        <SectionEyebrow>Proposed service guarantees</SectionEyebrow>
        <p className="mt-3 max-w-3xl text-sm text-muted-foreground">
          These guarantees are product proposals, not active contractual promises. Activate them
          only after the terms, billing credits and operational ownership are approved.
        </p>
          ...
          <div className="mt-6 grid gap-6 md:grid-cols-2">
            <div className="rounded-2xl border border-border/60 bg-card p-6 shadow-soft">
              ...
              <ul className="mt-4 space-y-2 text-sm text-muted-foreground">
                <li>• Private object storage with provider encryption at rest and encrypted transport.</li>
                <li>• AAL2 is enforced by server functions and database policies for sensitive vault access.</li>
                <li>• Sensitive downloads and changes are recorded; ordinary reads are not described as fully audited.</li>
                <li>• Case access is assignment based; administrators and designated supervisors retain oversight.</li>
            ...
            <div className="rounded-2xl border border-border/60 bg-card p-6 shadow-soft">
              ...
              <ul className="mt-4 space-y-2 text-sm text-muted-foreground">
                ...
                <li>• Suspected personal-data breach: assess promptly and notify the competent authority within 72 hours where Art. 33 DSGVO requires it.</li>
