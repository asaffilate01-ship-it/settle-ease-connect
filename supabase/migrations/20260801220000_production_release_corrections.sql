...
-- Remove the privileged demonstration identities created by historical seed
-- migrations. Production and staging administrators must be invited through
-- the audited role-invitation workflow.
DELETE FROM auth.users
WHERE lower(email) = ANY (ARRAY[
  'admin@beistand.de',
  'staff@beistand.de',
  'manager@beistand.de',
  'insurance-admin@beistand.de',
  'tax-admin@beistand.de',
  'benefits-admin@beistand.de',
  'medical-admin@beistand.de',
  'arrival-admin@beistand.de',
  'expert@beistand.de',
  'lawyer@beistand.de',
  'notary@beistand.de',
  'accountant@beistand.de',
  'doctor@beistand.de',
  'social-worker@beistand.de',
  'translator@beistand.de',
  'funeral@beistand.de',
  'mosque@beistand.de',
  'church@beistand.de',
  'temple@beistand.de',
  ...
  'agent@beistand.de',
  'family@beistand.de',
  'beneficiary@beistand.de'
]);

-- An accepted family grant is the source of truth. Historical acceptance also
-- inserted an unrestricted observer participant, which survived revocation.
...
-- Family users may see case progress, but documents, writing, quotes and
-- invoices are governed by their explicit grant rather than broad case access.
...
-- Enquiry notes use the constraint values defined by the operational schema.
...
-- Public submissions are accepted only by rate-limited server functions. Direct
-- anonymous PostgREST inserts would bypass those application controls.
