...
DROP POLICY IF EXISTS "Case operators create quotes" ON public.case_quotes;
DROP POLICY IF EXISTS "Case operators update quotes" ON public.case_quotes;
...
DROP POLICY IF EXISTS "vault owner reads own documents" ON public.vault_documents;
DROP POLICY IF EXISTS "vault owner creates own documents" ON public.vault_documents;
DROP POLICY IF EXISTS "vault owner updates own documents" ON public.vault_documents;
DROP POLICY IF EXISTS "vault owner deletes own documents" ON public.vault_documents;
DROP POLICY IF EXISTS "vault deputy reads allowed documents with assurance" ON public.vault_documents;
...
DROP POLICY IF EXISTS "partner admins manage invitations" ON public.partner_invitations;
...
BEGIN
  ...
  IF actor_email = '' OR actor_email <> lower(invitation.email) THEN
...
DROP POLICY IF EXISTS "internal staff read contact enquiries" ON public.contact_enquiries;
...
DROP POLICY IF EXISTS "finance reads expert payouts" ON public.expert_payouts;
DROP POLICY IF EXISTS "finance manages expert payouts" ON public.expert_payouts;
