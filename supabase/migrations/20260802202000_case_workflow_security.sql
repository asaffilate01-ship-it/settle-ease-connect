-- Align case workflow permissions with the UI: customers can communicate but
-- cannot create internal notes or change operational status. Staff writes
-- require an AAL2 session even when made directly through the Supabase API.
